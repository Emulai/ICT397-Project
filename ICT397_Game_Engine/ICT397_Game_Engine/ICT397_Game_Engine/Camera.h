...
public:
	...
	void SetLR(const int & tempX) {m_x = tempX;}
	void SetUD(const int & tempY) {m_y = tempY;}
	void SetFB(const int & tempZ) {m_z = tempZ;}

//    void SetRotateLR (const int temp) {lCam->SetRotateLR(temp);}
//    void SetRotateUD (const int temp) {lCam->SetRotateUD(temp);}
//    GLdouble GetRotateLR () {return lCam->GetRotateLR();}
//    GLdouble GetRotateUD () {return lCam->GetRotateUD();}
    ...
    void SetGravSpeed (const GLdouble &tempSpeed) {m_gravSpeed = tempSpeed;}
    void SetUD (const GLdouble &tempLoc)  {m_y = tempLoc;}
    ...
    void EmptyBoundingBoxes() {m_colDetect.EmptyBBox();}
    ...
    void EmptyPlains() {m_Plain.Clear();}
	//----------------------------------------------------------------------------------
	//  Get Methods
	//----------------------------------------------------------------------------------
